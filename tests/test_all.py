...
class CliTestCase(unittest.TestCase):
    ...
    def assert_outputs_created(self, dirname):
        ...
        self.assertEqual(set(os.listdir(os.path.join(dirname, 'ex1', 'BIOMD0000000297'))), set(['Time-Course.csv']))
        self.assertEqual(set(os.listdir(os.path.join(dirname, 'ex2', 'BIOMD0000000297'))), set(['Time-Course.csv']))

        files = [
            os.path.join(dirname, 'ex1', 'BIOMD0000000297', 'Time-Course.csv'),
            os.path.join(dirname, 'ex2', 'BIOMD0000000297', 'Time-Course.csv'),
        ]
