...
class CliTestCase(unittest.TestCase):
    ...
    def test_exec_sed_task_correct_time_course_attrs(self):
        ...
        numpy.testing.assert_allclose(second_half_variable_results['A'], full_variable_results['A'][10:], rtol=1e-5)
        ...
        numpy.testing.assert_allclose(offset_full_variable_results['A'], full_variable_results['A'], rtol=1e-5)
        ...
        numpy.testing.assert_allclose(offset_second_half_variable_results['A'], offset_full_variable_results['A'][10:], rtol=1e-5)
        numpy.testing.assert_allclose(offset_second_half_variable_results['A'], second_half_variable_results['A'], rtol=1e-5)
